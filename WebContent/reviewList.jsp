    ...
    <div class="review-container">
      <div class="review-table-header">
        <div class="add-review-button">
          ...
          <button type="button" class="btn btn-outline-primary" id="makeReview"><a href="/review?action=write&id=${video.url}">글작성</a></button>
        </div>
        <div class="search-area">
          ...
          <form>
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <div class="glass"><i class="bi bi-search"></i></div>
                <input type="password" class="form-control" id="inputText" placeholder="제목, 내용으로 검색">
              </div>
            </div>
          </form>
        </div>
